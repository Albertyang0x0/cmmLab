...
%token <type_node> SPACE

/*非终结符*/
%type <type_node> Program ExtDefList ExtDef ExtDecList
%type <type_node> Specifier StructSpecifier OptTag 
...
StructSpecifier : STRUCT OptTag LC DefList RC 	{treeNode childList[5] = {$1, $2, $3, $4, $5}; $$= newNode("StructSpecifier", 5, yylineno, childList);nodeList[nodeNum]=$$;nodeNum++;}
                | STRUCT ID                      {treeNode childList[2] = {$1, $2}; $$= newNode("StructSpecifier", 2, yylineno, childList);nodeList[nodeNum]=$$;nodeNum++;}
                ;
